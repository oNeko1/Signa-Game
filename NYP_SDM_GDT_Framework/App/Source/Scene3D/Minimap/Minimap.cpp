...
bool CMinimap::Init(void)
{
	...
	currentColour = glm::vec4(1.0f, 1.0f, 1.0f, 1.0f);
...
void CMinimap::Render(void)
{
	...
	//unsigned int colourLoc = glGetUniformLocation(CShaderManager::GetInstance()->activeShader->ID, "runtimeColour");
 ...
 */
void CMinimap::SetPlayerArrowCurrentColour(glm::vec4 value)
{
	currentColour = value;
}
